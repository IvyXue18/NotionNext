const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客 | Welcome to my blog!', url: 'https://ivyxue8120.com/' }
  ],
  ...
  // 英雄区(首页顶部大卡)
  HEO_HERO_TITLE_1: '被AI重构的',
  HEO_HERO_TITLE_2: '有趣流程',
  HEO_HERO_TITLE_3: '产品，设计，编程，营销',
  HEO_HERO_TITLE_4: '置顶必读',
  ...
  HEO_HERO_CATEGORY_2: { title: '热门 Popular', url: '/tag/热门' },
  HEO_HERO_CATEGORY_3: { title: '教程 Tutorials', url: '/tag/教程' },
  ...
  HEO_INFO_CARD_URL: 'https://github.com/IvyXue18', // 个人资料底部按钮链接
